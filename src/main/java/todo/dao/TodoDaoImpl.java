...
public class TodoDaoImpl implements TodoDao {
    ...
    private static final String SELECT_TODO_BY_ID = "select id,title,username,"
            + "description,target_date,is_done from todos where id =?";
    private static final String SELECT_ALL_TODOS = "select * from todos";
    private static final String DELETE_TODO_BY_ID = "delete from todos where id = ?;";
    private static final String UPDATE_TODO = "update todos set title = ?, username= ?, "
            + "description =?, target_date =?, is_done = ? where id = ?;";
    ...
    public void insertTodo(Todo todo) {
        ...
        try {
            try (Connection connection = connectionUtil.getConnection();
                ...
                preparedStatement.setDate(4, connectionUtil.getSqlDate(todo.getTargetDate()));
                preparedStatement.setBoolean(5, todo.getStatus());
                System.out.println(preparedStatement);
                preparedStatement.executeUpdate();
            }
        } catch (SQLException e) {
            throw new DataProcessingException("Can't add todo " + todo, e);
        }
    }
    ...
    public Todo selectTodo(long todoId) {
        ...
        try (Connection connection = connectionUtil.getConnection();
            ...
            throw new DataProcessingException("Can't select todo " + todoId, e);
        }
        return todo;
    }
    ...
    public List<Todo> selectAllTodos() {
        ...
        try (Connection connection = connectionUtil.getConnection();
            ...
            throw new DataProcessingException("Can't select all todo " + todos, e);
        }
        return todos;
    }
    ...
    public boolean deleteTodo(int id) {
        ...
        try (Connection connection = connectionUtil.getConnection();
            ...
            throw new DataProcessingException("Can't delete todo " + id, e);
        }
        return rowDeleted;
    }
    ...
    public boolean updateTodo(Todo todo) {
        ...
        try {
            try (Connection connection = connectionUtil.getConnection();
                ...
                statement.setDate(4, connectionUtil.getSqlDate(todo.getTargetDate()));
                statement.setBoolean(5, todo.getStatus());
                statement.setLong(6, todo.getId());
                rowUpdated = statement.executeUpdate() > 0;
            }
        } catch (SQLException e) {
            throw new DataProcessingException("Can't update todo " + todo, e);
        }
        return rowUpdated;
    }
